...
use App\Ship\Core\Abstracts\Models\UserModel as User;
...
use App\Ship\Core\Traits\StateKeeperTrait;
...
abstract class Request extends LaravelRequest
{
     ...
     *
     * @template T of Transporter
     * @psalm-return T
     */
    public function toTransporter()
    {
        /**
         * @psalm-var class-string<T> $transporterClass
         */
