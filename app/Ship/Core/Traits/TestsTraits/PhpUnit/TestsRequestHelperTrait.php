...
use App\Ship\Core\Exceptions\MissingTestEndpointException;
use App\Ship\Core\Exceptions\UndefinedMethodException;
use App\Ship\Core\Exceptions\WrongEndpointFormatException;
...
trait TestsRequestHelperTrait
{
    ...
    /**
     * Change to public we need because some web routes need to test by makeCall and all web routes has different url.
     */
