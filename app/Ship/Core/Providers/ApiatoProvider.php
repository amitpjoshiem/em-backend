...
use App\Ship\Core\Manifest\MergePluginPackageManifest;
...
class ApiatoProvider extends AbstractMainProvider
{
    ...
    {
        App::register(EventServiceProvider::class); //The custom apiato EventService Provider
    }

    private function overridePackageManifest()
    {
