...
return [
    ...
    'ship' => [
        ...
        |--------------------------------------------------------------------------
        */
        'namespace-ship-provider'      => 'App\Ship\Providers\ShipProvider',
    ],
    ...
    */
    ...
    'api' => [
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Enable/Disable Auto passport:purge command
        |--------------------------------------------------------------------------
        */
        'enabled-schedule-passport-purge'   => env('API_SCHEDULE_PASSPORT_PURGE', false),
    ...
    'frontend' => [
        'url' => env('APP_FRONTEND_URL', 'https://localhost'),
    ],
