...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This configuration value allows you to cache the token for Passport
    |
    */
    ...
    'cache' => [
        'client' => [
            // Cache key prefix
            'prefix' => 'passport.client.',

            // The lifetime of client cache, in second
            'expires_in' => 5 * 60,
        ],
        'token' => [
            // Cache key prefix
            'prefix' => 'passport.token.',

            // The lifetime of token cache, in second
            'expires_in' => 5 * 60,
        ],
    ],
];
