...
class DeleteAssetsConsolidationsRequest extends Request
{
    /**
     * The assigned Transporter for this Request.
     */
    protected ?string $transporter = DeleteAssetsConsolidationsTransporter::class;
    ...
    {
        return [
            'id' => 'required|exists:assets_consolidations',
        ];
    }
