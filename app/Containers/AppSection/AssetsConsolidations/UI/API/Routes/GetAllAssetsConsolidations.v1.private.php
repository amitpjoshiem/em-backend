...
/**
 * @OA\GET (
 *     path="/assets_consolidations/{member_id}",
...
Route::get('assets_consolidations/{member_id}', [Controller::class, 'getAllAssetsConsolidations'])
    ->name('api_assetsconsolidations_get_all_assets_consolidations')
