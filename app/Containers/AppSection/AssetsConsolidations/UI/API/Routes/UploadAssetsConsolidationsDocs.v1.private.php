...
/**
 * @OA\Post (
 *     path="/assets_consolidations/{member_id}/upload",
 *     tags={"AssetsConsolidations"},
 *     summary="Upload AssetsConsolidation",
 *     description="Upload AssetsConsolidation DOcs",
 *     @OA\Parameter(
...
Route::post('assets_consolidations/{member_id}/upload', [Controller::class, 'uploadAssetsConsolidationsDocs'])
    ->name('api_assetsconsolidations_upload_assets_consolidations_docs')
