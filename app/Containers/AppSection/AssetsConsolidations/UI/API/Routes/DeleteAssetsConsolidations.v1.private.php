 ...
 *     summary="Delete AssetsConsolidations",
 *     description="Delete AssetsConsolidations",
 *     @OA\Parameter(
...
Route::delete('assets_consolidations/{id}', [Controller::class, 'deleteAssetsConsolidations'])
    ->name('api_assetsconsolidations_delete_assets_consolidations')
