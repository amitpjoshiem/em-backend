...
/**
 * @OA\Patch (
 *     path="/members/convert/{id}",
 *     tags={"Member"},
 *     summary="Convert Member To Client",
 *     description="Convert Member To Client",
 *     @OA\Parameter(
...
Route::patch('members/convert/{id}', [MemberApiController::class, 'convertToClient'])
    ->name('api_member_convert_to_client')
