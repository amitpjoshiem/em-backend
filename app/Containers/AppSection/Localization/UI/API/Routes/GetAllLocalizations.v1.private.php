...
use App\Containers\AppSection\Localization\UI\API\Controllers\Controller as LocalizationApiController;
use Illuminate\Support\Facades\Route;

Route::get('localizations', [LocalizationApiController::class, 'getAllLocalizations'])
