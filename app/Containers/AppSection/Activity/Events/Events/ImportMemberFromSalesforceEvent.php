...
class ImportMemberFromSalesforceEvent extends AbstractActivityEvent
{
    ...
    public static function getActivityHtmlString(array $data): string
    {
        ...
        return sprintf("<p>New Member <a href='%s'>%s</a> imported from Salesforce</p>", $url, $data['member_name']);
    }
