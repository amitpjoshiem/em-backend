...
class MemberUpdateBasicInfoEvent extends AbstractActivityEvent
{
    ...
    public static function getActivityHtmlString(array $data): string
    {
        ...
        return sprintf("<p>You have changed <a href='%s'>%s</a> Basic Information details</p>", $url, $data['member_name']);
    }
