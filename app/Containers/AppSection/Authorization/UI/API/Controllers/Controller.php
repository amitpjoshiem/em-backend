...
class Controller extends ApiController
{
    ...
    {
        $user = DB::transaction(fn () => app(AssignUserToRoleAction::class)->run($request));
    ...
    {
        $user = DB::transaction(fn () => app(SyncUserRolesAction::class)->run($request));
    ...
    {
        $role = app(AttachPermissionsToRoleAction::class)->run($request->toTransporter());
    ...
    {
        $role = app(SyncPermissionsOnRoleAction::class)->run($request->toTransporter());
    ...
    {
        $role = app(CreateRoleAction::class)->run($request->toTransporter());
    ...
    {
        $permission = app(CreatePermissionAction::class)->run($request);
