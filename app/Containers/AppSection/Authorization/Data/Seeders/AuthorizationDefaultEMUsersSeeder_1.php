...
class AuthorizationDefaultEMUsersSeeder_1 extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        Company::factory()->create([
            ...
            $this->addBaseUser('preeti1@engineersmind.com', '111111', 'PreetiL', RolesEnum::advisor(), $company->id);
            ...
            $this->addBaseUser('amitjoshi@engineersmind.com', '111111', 'Support', RolesEnum::support(), $company->id);
            $this->addBaseUser('amitjoshi2188@gmail.com', '111111', 'Support', RolesEnum::support(), $company->id);
        });
