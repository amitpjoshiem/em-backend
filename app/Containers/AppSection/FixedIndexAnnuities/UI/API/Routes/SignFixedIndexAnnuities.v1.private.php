...
/**
 * @OA\Post (
 *     path="/fixed_index_annuities/sign/{id}",
...
Route::post('fixed_index_annuities/sign/{id}', [Controller::class, 'signFixedIndexAnnuities'])
    ->name('api_fixedindexannuities_sign_fixed_index_annuities')
