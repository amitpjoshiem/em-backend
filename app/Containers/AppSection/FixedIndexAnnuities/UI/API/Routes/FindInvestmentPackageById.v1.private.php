...
/**
 * @OA\Get (
 *     path="/investment_package/find/{id}",
 *     tags={"InvestmentPackeage"},
 *     summary="Find InvestmentPackeage",
 *     description="Find InvestmentPackeage",
 *      @OA\Response(
 *          response=204,
...
Route::get('/investment_package/find/{id}', [Controller::class, 'findInvestmentPackage'])
    ->name('api_fixedindexannuities_find_investment_package')
