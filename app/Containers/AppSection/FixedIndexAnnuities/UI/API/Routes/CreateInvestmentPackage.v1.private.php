...
/**
 * @OA\POST (
 *     path="/investment_package/{fixed_index_annuities_id}",
...
Route::post('/investment_package/{fixed_index_annuities_id}', [Controller::class, 'createInvestmentPackage'])
    ->name('api_fixedindexannuities_create_investment_package')
