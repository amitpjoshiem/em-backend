...
/**
 * @OA\POST (
 *     path="/fixed_index_annuities/{member_id}",
 *     tags={"FixedIndexAnnuities"},
 *     summary="Create FixedIndexAnnuities",
 *     description="Create FixedIndexAnnuities",
 *     @OA\RequestBody(
 *          required=true,
 *          @OA\JsonContent(
...
Route::post('fixed_index_annuities/{member_id}', [Controller::class, 'createFixedIndexAnnuities'])
    ->name('api_fixedindexannuities_create_fixed_index_annuities')
