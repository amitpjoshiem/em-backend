...
/**
 * @OA\GET (
 *     path="/fixed_index_annuities/find/{id}",
...
Route::get('fixed_index_annuities/find/{id}', [Controller::class, 'findFixedIndexAnnuitiesById'])
    ->name('api_fixedindexannuities_find_fixed_index_annuities_by_id')
