 ...
 *     tags={"User"},
 *     summary="Create a password for an user.",
 *     description="Create password by token email and passwords",
 *     @OA\RequestBody(
 *          required=true,
 *          @OA\JsonContent(
 ...
 * )
 */
Route::post('/password/create', [UserApiController::class, 'createUserPassword'])
    ->name('api_user_create_password');
